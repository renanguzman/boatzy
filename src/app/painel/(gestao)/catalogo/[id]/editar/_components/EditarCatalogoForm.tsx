...
import { atualizarCatalogo } from '../actions';
...
export default function EditarCatalogoForm({ catalogo }: Props) {
  const router = useRouter();

  const [form, setForm] = useState({
    descricao: catalogo.descricao,
    valor: String(catalogo.valor),
    tipo: catalogo.tipo,
  });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await atualizarCatalogo(catalogo.id, {
    ...
    setFeedback({ type: 'success', msg: 'Item atualizado com sucesso!' });
    setSubmitting(false);
