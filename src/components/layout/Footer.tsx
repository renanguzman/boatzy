...
export default function Footer() {
  return (
    <footer className="bg-[#0B2447] text-white" id="footer">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-12 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/help" className="text-sm text-slate-300 hover:text-white transition-colors">
                  Central de Ajuda
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-6 gap-4">
          <p className="text-xs text-slate-400">
            © {new Date().getFullYear()} Boatzy. Navegue com Elegância. Todos os direitos reservados.
          </p>
