...
export type TipoVendaOption = { id: string; nome: string };

type Props = {
  /** Tipos disponíveis (apenas os com anúncio ativo), carregados no servidor. */
  options: TipoVendaOption[];
  value: TipoVendaOption | null;
  onChange: (value: TipoVendaOption | null) => void;
  isOpen: boolean;
  onOpen: () => void;
  onClose: () => void;
  compact?: boolean;
...
export default function TipoVendaPicker({ options, value, onChange, isOpen, onOpen, onClose, compact }: Props) {
  return (
