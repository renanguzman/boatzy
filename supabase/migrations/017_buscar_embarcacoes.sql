-- ============================================================
-- BUSCA DE EMBARCAÇÕES (hotsite)
-- Resolve, em uma única chamada, os filtros da busca do cliente:
...
--   • Data: disponibilidade considerando dias da semana de
--     operação + bloqueios. Com flexibilidade (±N dias), basta
--     que QUALQUER dia da janela esteja disponível.
--   • Pessoas: capacidade >= pessoas.
-- Ordena por distância (mais próximas primeiro) quando há centro;
-- caso contrário, pelas mais recentes. Retorna também o total
